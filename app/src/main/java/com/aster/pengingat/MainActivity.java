...
public class MainActivity extends AppCompatActivity {
    ...
    private Notification getNotification(String content){
        ...
        //Saat notifikasi diklik maka akan diarahkan ke MainActivity
        ...
        builder.setSmallIcon(R.drawable.judul);
    ...
    private void insertDataToDb(String title, String date, String time){
      ...
      if (insertData){
          try {
              populateListView();
              toastMsg("Data ditambahkan");
          }catch (Exception e){
              e.printStackTrace();
          }
      }else
          toastMsg("Ups terjadi kesalahan saat menyimpan!");
    }
    ...
    private void populateListView() {
        try {
            ...
            ItemAdapter itemsA = new ItemAdapter(this, items);
            itemListView.setAdapter(itemsA);
            itemsA.notifyDataSetChanged();
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    private void hideFab(){
        itemListView.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            public void onScrollStateChanged(AbsListView viewi, int scrollState) {
    ...
    private void showAddDialog(){
        ...
        dialogBuilder.setTitle("Buat data baru");
        dialogBuilder.setPositiveButton("Tambah", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (title.length() !=0){
                    ...
                    toastMsg("Ups, Data tidak bisa kosong");
                }
            }
        });
